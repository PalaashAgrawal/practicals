...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5ebf62f979bd9cd6567fb6385e79746fcb365de215f27a48949907605d713ca7.js',function(){input.required=false;search();});}
