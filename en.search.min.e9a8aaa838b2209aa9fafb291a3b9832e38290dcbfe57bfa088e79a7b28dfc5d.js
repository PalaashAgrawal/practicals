...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5ccca0b32e18bcec0d3d15d848a9ea919684083a88c2130a48688718f7b2cd3a.js',function(){input.required=false;search();});}
